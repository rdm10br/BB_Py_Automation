...
"}")
        ...
        self.widget.setGeometry(QRect(5, 110, 46, 336))
...
"}")
        ...
        self.widget1 = QWidget(self.icon_text_widget)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(0, 110, 131, 236))
        ...
        self.splitter_4.setGeometry(QRect(2, 5, 126, 199))
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.DoubleCheck)

        self.Copia = QFrame(self.widget1)
        ...
        self.splitter_6.setGeometry(QRect(2, 5, 121, 111))
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.Copia)

        self.Data = QFrame(self.widget1)
        ...
        self.splitter_7.setGeometry(QRect(0, 0, 126, 86))
...
"}")
        ...
        self.splitter_5.setGeometry(QRect(2, 5, 126, 91))
...
"}")
        ...
        self.widget2.setGeometry(QRect(0, 349, 131, 96))
