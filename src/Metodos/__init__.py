...
from Metodos.Mescla import (MesclaOrfãoCA, ajuste_av1_av2, atribGrup,
                            gruposAtividades, AjusteNotaZero, AjusteLinkEbook,
                            openMescla, remove_ser, DoubleCheckDB, falecomtutor,
                            Ocultar, Prof, ajuste_position, DCE_Mescla, Fael,
                            grupo_fael, Expurgo, limpar_sala)
from Metodos.BQ import getBQ, fileChooser, create_bq, junctionWindow, junctionSizeWindow
from Metodos.Avulsos import ajuste_AV1, ajuste_AV2, ajuste_Canal, ajuste_manual, ajuste_emp, consu