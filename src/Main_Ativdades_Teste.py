...
async def run(page: Page, index) -> None:
    ...
    course_mapping = {
        ...
        "['Educação II']": [
            "Ciências Biológicas", "Geografia", "História", "Letras - Espanhol",
            "Letras - Inglês", "Letras - Português", "Letras - Português e Espanhol",
            "Licenciatura em Educação Especial", "Licenciatura em Educação Física", "Matemática"
        ],
        "['Educação III']": ["Pedagogia"],
        "['Exatas']": [
            "Ciências Aeronáuticas", "Engenharia Civil", "Engenharia de Produção",
            "Engenharia Elétrica", "Engenharia Mecânica"
        ],
        "['Negócios e Gestão I']": [
            "Administração", "Ciências Contábeis", "Ciências Econômicas", "Gestão Hospitalar"
        ],
        "['Negócios e Gestão II']": [
            "Gastronomia", "Gestão Ambiental", "Gestão da Qualidade", "Gestão de Recursos Humanos",
            "Gestão Financeira", "Negócios Imobiliários"
        ],
        "['Negócios e Gestão III']": [
            "E-Commerce", "Gestão Comercial", "Gestão de Trânsito", "Logística", "Processos Gerenciais"
        ],
        "['Saúde I']": [
            "Biomedicina", "Enfermagem", "Farmácia"
        ],
        "['Saúde II']": ["Estética e Cosmética", "Podologia"],
        "['Saúde III']": [
            "Bacharelado em Educação Física", "Fisioterapia", "Nutrição", "Terapia Ocupacional"
        ],
        "['Serviço Social e Teologia']": ["Serviço Social", "Teologia"],
        "['Tecnologia da Informação']": [
            "Analise e Desenvolvimento de Sistema", "Ciência De Dados/Data Science", "Coding",
            "Computação Em Nuvem", "Digital Security", "Empreendedorismo Digital",
            "Experiência do Usuário e Modelagem de Projetos Inovadores", "Game Design",
            "Inteligência Artificial", "Internet das Coisas", "Service Design", "Tecnologia da Informação"
        ],
        "['Arquitetura e Design']": ["Arquitetura e Urbanismo", "Design de Interiores"],
        "['Comunicação']": [
            "Coaching Digital", "Coaching e Mentoring", "Filmmaker", "Marketing", "Streaming Profissional"
        ],
        "['Negócios e Gestão IV']": [
            "Ciência Política", "Gestão da Qualidade", "Gestão de Serviços Jurídicos, Cartorários e Notariais",
            "Gestão de Serviços Jurídicos e Notariais", "Gestão Pública", "Segurança Pública"
        ]
    }
